Surface-level ozone (\ce{O3}) is a secondary air pollutant formed from the photochemical degradation of volatile organic compounds (VOCs) in the presence of nitrogen oxides (\ce{NO_x}) \citep{Atkinson:2000}.
...
Many studies over the US \citep{Sillman:1995a; Pusede:2014} \todo{choose proper citations} have observed the relationship between ozone and temperature, noting that increased temperatures tend to lead to higher ozone levels, often exceeding local air quality guidelines.
...
%\citet{Carter:XXXX} note that when ozone production is fuelled through PAN decomposition, this occurs at a slower rate than at lower temperatures.
\citet{Hatakeyama:XXXX} looked primarily at the influence of \ce{HO2NO2} decomposition on ozone production and induced that at lower temperatures (T $\le$ XXX~K) \ce{HO2NO2} decomposition has a large influence on ozone production but the influence of PAN decomposition on ozone production increases with temperature.

\citet{Pusede:2014} used observations over the San Joaquin Valley, California to infer a non-linear relationship of ozone production with temperature and \ce{NO_x}, similar to the well-known non-linear relationship of ozone production on \ce{NO_x} and VOC levels \citep{Sillman:XXXX; Kleinman:1994}.
