...
Regional modelling studies have concentrated on reproducing ozone levels over a particular region with known meteorology and \ce{NO_x} conditions and then varying the temperature and not considering the relationship of ozone with \ce{NO_x} with temperature.
