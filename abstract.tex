...
The increased rate emitted VOC oxidation with temperature controlled the rate of \ce{O_x} production.
...
Simulating stagnant conditions with moderate \ce{NO_x} conditions reproduced $2$~ppbv increase in ozone per \degree C from the observational and model data.
