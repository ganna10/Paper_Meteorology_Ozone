...
Under high-\ce{NO_x} conditions, an increase in ozone from $20$~\degree C to $40$~\degree C of up to $20$~ppbv was due to faster reaction rates while increased isoprene emissions added a further $11$~ppbv of ozone.
The increased rate of emitted VOC oxidation with temperature controlled the rate of \ce{O_x} production.
...
Model simulations without mixing and VOC-and-\ce{NO_x}-sensitive chemistry reproduced $2$~ppbv increase in ozone per \degree C from the observational and model data.
