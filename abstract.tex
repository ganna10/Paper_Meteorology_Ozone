...
In this study, we used a box model to reproduce the non-linear relationship of ozone with \ce{NO_x} and temperature from previous observational studies.
...
The increased rate of emitted VOC loss with temperature controlled the rate of \ce{O_x} production with temperature increasing net \ce{O_x} production by $\sim1$~molecule of \ce{O_x} per loss of VOC.
