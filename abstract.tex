...
The increase of ozone with temperature is coupled with an increase in OH with temperature resulting in increased VOC reactivity with temperature that causes an increase in net \ce{O_x} production of $\sim1$~molecule of \ce{O_x} per loss of VOC.
