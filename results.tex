...
The budgets are allocated to the net contribution of major sources, where `HO2', `RO2', `ARO2' represent the reactions of NO with \ce{HO2}, alkyl peroxy radicals and acyl peroxy radicals respectively.
...
The net \ce{O_x} production efficiency increases from $20$~\degree C to $40$~\degree C by $\sim1$~molecule of \ce{O_x} per molecule of VOC oxidised using both temperature-dependent and temperature-independent isoprene emissions and in each \ce{NO_x} condition (Fig.~\ref{f:ozone_budgets}).
...
As the production efficiency of \ce{O_x} remains constant with temperature in Fig.~\ref{f:ozone_budgets}, the rate of \ce{O_x} production is controlled by the loss rate of the VOCs.
Faster oxidation of VOCs leads to a faster production rate with temperature of peroxy radicals which when converting NO to \ce{NO2} produce more ozone with temperature.
...
Also, the modelling study of \citet{Steiner:2006} noted that the increase in initial oxidation rates of VOCs with temperature leads to increased formaldehyde concentrations and since formaldehyde is an important source of radicals leading to an increase of ozone with temperature.

The net effect of peroxy nitrates on \ce{O_x} production efficiency in our study is negligible, contributing to a decrease in $\sim0.1$~molecules of \ce{O_x} per VOC oxidised at $40$~\degree C from $20$~\degree C.
Peroxynitrates are produced from the reactions of acyl peroxy radicals with \ce{NO2} and are an important reservoir of both peroxy radicals and \ce{NO_x}.
The decomposition rate of peroxy nitrates is strongly temperature dependent, thus at higher temperatures the faster decomposition rate leads to faster re-release of peroxy radicals and \ce{NO_x} influencing the production of ozone.
This lack of influence of RO2NO2 on the net production efficiency of \ce{O_x} is rather surprising given that many other studies cite the decrease in the lifetime of peroxy nitrates as one of the most important factors for the increase of ozone with temperature.
...
The increase in ozone with temperature also leads to an increase in OH with temperature through the following reaction sequence.
\begin{rxnarray}
    && \ce{O3 + h\nu} \rightarrow \ce{O(^1D) + O2} \\ \label{r:O3_hv} 
    && \ce{O(^1D) + H2O} \rightarrow \ce{OH + OH} \label{r:O1D_H2O}
\end{rxnarray}
The degradation of VOCs after reaction with OH results in either net production or consumption of ozone depending on the \ce{NO_x} conditions.
In low-\ce{NO_x} conditions, peroxy radicals produced from the degradation of VOCs are more likely to react with other peroxy radicals leading to a net sink of ozone.
With increasing \ce{NO_x} levels, peroxy radicals may react with NO producing \ce{NO2} leading to net ozone production depending on the number of peroxy radicals produced during VOC degradation.
Increasing \ce{NO_x} levels even further increases nitric acid formation from the reaction of OH and \ce{NO2} limiting ozone production.
This non-linear chemistry of ozone production is evident in Fig.~\ref{f:ozone_contours}.

The degradation of VOCs recycles OH during the reactions of many secondary degradation products.
For example, OH and \ce{NO2} are the products of the reaction of \ce{HO2} with NO which has the largest single contribution to the \ce{O_x} production efficiency (Fig.~\ref{f:ozone_budgets}).
Thus showing the strong coupling of the increase of ozone and OH with temperature.
...
Model output from the 3D WRF-Chem regional model set-up over the European domain for simulations of the year 2007 using MOZART-4 chemistry from \citet{Mar:2016} was used to further compare the box model simulations to a model including more meteorological processes than the box model.
...
The spread of the observed ozone-temperature values over both Germany and Poland are generally captured by the combined WRF-Chem simulations.
...
In our simulations, we focused on instantaneous production of ozone from a freshly-emitted source of VOC not considering stagnant atmospheric conditions which are characteristed by high temperatures and low wind speeds slowing the transport of ozone and its precursors away from sources.
...
Stagnantion is an example of the coupling of meteorological variables, in this case temperature and wind speed, impacting ozone production.
In observational studies, which look at the total derivative of ozone with temperature, the direct effects of temperature (e.g. increasing reaction rates, emissions from vegetation) and indirect (e.g. heatwaves characterised by high temperatures and low wind speed) effects of temperature on ozone are not easily separated.
