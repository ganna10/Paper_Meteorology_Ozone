...
\begin{table}[t]%
    ...
    \begin{subtable}[t]{\textwidth}%
        \centering%
        \vspace{2mm}
        \caption{Slope of linear fit of box model experiments for each chemical mechanism, type of isoprene emissions allocated to the three \ce{NO_x}-regimes.}%
...
The large spread of the ERA-Interim ozone values over both Germany and Poland at the different temperatures are well captured by the combined WRF-Chem simulations using both MOZART-4 and RADM2 chemistry. 
...
The slopes from the box model results is best in the High-\ce{NO_x}.
