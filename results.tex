...
The highest mixing ratios of ozone are produced at high temperatures and high emissions of \ce{NO_x} regardless of the source of isoprene emissions.
...
The Low-\ce{NO_x} regime corresponds to regions with little increase in ozone with temperature, also called \ce{NO_x}-sensitive regime.
The High-\ce{NO_x} (or \ce{NO_x}-saturated) regime is when ozone levels increase rapidly with temperature and the contour ridges correspond to regions of maximal ozone production and we call this the Maximal-\ce{O3} regime.
\citet{Pusede:2014} showed that temperature can be used as a proxy for VOC, thus we used the ratio of \ce{HNO3} to \ce{H2O2} used by \citet{Sillman:1995} to assign the ozone mixing ratios for each simulation to one of the \ce{NO_x} regimes.

Fig.~\ref{f:O3-T} illustrates the mean ozone mixing ratio at each temperature in the \ce{NO_x} regimes for each chemical mechanism and each source of isoprene emissions.  
...
Table~\ref{t:differences} shows that the absolute increase in ozone due to faster chemistry is larger than the absolute increase in ozone due to increased isoprene emissions for each chemical mechanism and each \ce{NO_x} regime.
...
We determine the chemical processes responsible for the increases in ozone mixing ratios at $40$~\degree C from $20$~\degree C by analysing \ce{O_x} production budgets in Sect.~\ref{ss:r_budgets}.

Comparing the response of ozone to temperature in the reduced chemical mechanisms (CRIv2, MOZART-4, CB05 and RADM2) to the near-explicit MCMv3.2 chemical mechanism shows that the largest differences from the MCMv3.2 occur in the Maximal-\ce{O3} and High-\ce{NO_x} regimes.
...
RADM2 produces $3$~ppbv less ozone than the MCMv3.2 due to increased isoprene emissions in each \ce{NO_x} regime, indicating that this difference is due to how isoprene degradation chemistry is treated in RADM2.
...
Peroxy nitrates are formed from the reactions of peroxy radicals with \ce{NO2} (\ref{r:RO2_NO2}) and are an important reservoir species for both peroxy radicals and \ce{NO_x}.
\begin{rxnarray}
...
At low temperatures, \ce{RO2NO2} can accumulate and be transported downwind of emissions of the sources of its precursors (VOC and \ce{NO_x}) and after thermal decomposition the release of \ce{NO2} and peroxy radicals can promote production of \ce{O3} \citep{Moxim:1996}.
...
In fact when removing the contribution of \ce{CH3O2NO2} to normalised \ce{RO2NO2} production in MCMv3.2, the normalised \ce{RO2NO2} production of the reduced chemical mechanisms is similar to that in the MCMv3.2 for each \ce{NO} regime and regardless of isoprene source.  
...
\colorbox{red}{Katie} provided model output from the 3D WRF-Chem regional model set-up over the European domain for simulations of the year 2007 using MOZART-4 and RADM2 chemistry \todo{Katie ref.}.
...
The spread of the ERA-Interim ozone-temperature values over both Germany and Poland are generally captured by the WRF-Chem simulations combining both MOZART-4 and RADM2 chemistry. 
...
High-\ce{NO_x} conditions with a temperature-dependent source of isoprene produce the most similar ozone-temperature slope to the observational data but this is still lower by a factor of two than the observed ozone-temperature slope.
...
In our simulations, we focused on instantaneous production of ozone from a freshly-emitted source of VOC rather than stagnant atmospheric conditions.
