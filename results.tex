...
The Low-\ce{NO_x} regime corresponds to regions with little increase in ozone with temperature, also called the \ce{NO_x}-sensitive regime.
...
The degradation of isoprene has been extensively studied and it is well-known that methyl vinyl ketone (MVK) and methacrolein are signatures of isoprene degradation. \todo[noline]{reference}
...
\todo[inline]{check differences in emissions from TNO in 2007 and 2011}
...
Figure~\ref{f:comparison} compares the observational (ERA-Interim) and WRF-Chem data from summer 2007 to the maximum 8~h mean ozone from the box model simulations for each chemical mechanism, \ce{NO_x} regime and source of isoprene emissions.
