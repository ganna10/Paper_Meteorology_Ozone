...
The results in Table~\ref{t:differences} show that the absolute increase in ozone due to faster chemistry is larger than the absolute increase in ozone due to increased isoprene emissions for each cehmical mechanism and each \ce{NO_x} regime.
...
At high temperatures, most of the difference in the normalised \ce{O_x} production using the reduced chemical mechanisms from the MCMv3.2 is due to differences in the contribution from peroxy nitrate (RO2NO2) decomposition.
The difference in the maximum contribution of RO2NO2 to normalised \ce{O_x} production of the total difference in normalised \ce{O_x} production ranges from $65$~\% using CB05 and up to $86$~\%  with CRIv2.

Thermal decomposition of RO2NO2 also has the largest contribution to the normalised \ce{O_x} production at higher temperatures in Fig.~\ref{f:ozone_budgets} and will be analysed further in Sect.~\ref{sss:ro2no2}.
