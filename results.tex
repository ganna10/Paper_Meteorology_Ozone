...
This non-linear relationship is similar to that determined by \citet{Pusede:2014} using an analytical model constrained to observational measurements over San Joaquin Valley, California.
...
As the production efficiency of \ce{O_x} remains constant with temperature (Fig.~\ref{f:ozone_budgets}), the rate of \ce{O_x} production is controlled by the loss rate of the VOCs.
...
Peroxynitrates are produced from the reactions of acyl peroxy radicals with \ce{NO2} and are an important reservoir of peroxy radicals and \ce{NO_x}.
