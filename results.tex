...
The increase in ozone mixing ratio at $40$~\degree C from $20$~\degree C due to faster reaction rates with High-\ce{NO_x} conditions is almost double that under Low-\ce{NO_x} conditions.
...
Faster oxidation of VOCs with temperature speeds up the production of peroxy radicals which increases ozone production when peroxy radicals react with NO to produce \ce{NO2}.
...
\end{rxnarray}
Furthermore, enhanced formaldehyde production from the faster oxidation of VOCs increases \ce{HO2} formation which speeds up the reaction rate of the reaction of \ce{HO2} and NO.
\begin{rxnarray}
    && \ce{HO2 + NO} \rightarrow \ce{NO2 + OH} \label{r:HO2_NO}
\end{rxnarray}
\eqref{r:HO2_NO} is responsible for both ozone production (due to \ce{NO2} production) and OH recycling further illustrating the strong coupling of ozone and OH production.
...
The decomposition rate of peroxy nitrates is strongly temperature dependent and at higher temperatures the faster decomposition rate of \ce{RO2NO2} leads to faster release of peroxy radicals and \ce{NO_x} influencing ozone production.
The lack of influence of RO2NO2 on \ce{O_x} budgets in Fig.~\ref{f:ozone_budgets} is surprising as many other studies cite the decrease in the lifetime of peroxy nitrates as one of the most important factors for the increase of ozone with temperature.
...
\citet{Steiner:2006} also recognised that the decrease in PAN lifetime with temperature may contribute to the increase of ozone with temperature and concluded that the combined effects of increased VOC reactivity and PAN decomposition are most likely to increase the production of ozone with temperature.
