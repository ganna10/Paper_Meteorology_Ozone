...
Thus when modelling the air quality over a particular region using RADM2 and CB05, these mechanisms would simulate more }\chem{NO_x}\DIFadd{-sensitive chemistry and a lower increase of ozone with temperature than the MCMv3.2, CRIv2 and MOZART-4 chemical mechanisms for the same conditions (i.e.~emissions, meteorology and radiation).}\DIFaddend 
...
\DIFaddbegin \DIFadd{The increased VOC reactivity with temperature is dominated by the increased reactivity of aldehydes at higher temperatures, the supplementary material illustrates the contributions of different VOC functional groups to the total reactivity per emitted molecule of VOC.
This result is also consistent with }\citet{Steiner:2006} \DIFadd{who linked the increased formaldehyde concentrations at higher temperatures with the increase of ozone with temperature.}
...
Out of the metereological conditions not represented by }\DIFaddend our box model\DIFaddbegin \DIFadd{, stagnation could have the largest influence on the increase of ozone with temperature
...
Moreover, the }\chem{O_x} \DIFadd{budgets }\DIFaddend normalised by the chemical loss rate of VOC \DIFdelbegin \DIFdel{remains unchanged.Furthermore, }\DIFdelend \DIFaddbegin \DIFadd{for the simulations without mixing show no appreciable difference to the simulations including mixing (Fig.~4b).
