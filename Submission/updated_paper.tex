...
The relative difference in ozone mixing ratio produced using each reduced chemical mechanism from the MCMv3.2 is shown in Fig.~\ref{f:ozone_diffs}.
...
Regions of high temperatures and high \chem{NO_x} emissions in Fig.~\ref{f:ozone_diffs} generally lead to the largest inter-mechanism differences between ozone mixing ratios using reduced chemical mechanisms from the MCMv3.2 (up to $13$~\%).
These differences in peak ozone mixing producing from the reduced chemical mechanisms from the MCMv3.2 in each \chem{NO_X} condition is consistent with Fig.~\ref{f:O3-T} where RADM2 and CB05 produce generally produced higher ozone levels than the MCMv3.2.
Also consistent with Fig.~\ref{f:O3-T}, CRIv2 produced the most similar amounts of ozone to the MCMv3.2 in each \chem{NO_x} condition whereas MOZART-4 tended to produced lower ozone mixing ratios than the MCMv3.2 in High-\chem{NO_x} conditions.
In Fig.~\ref{f:O3-T}, a maximum difference of $10$~ppbv between ozone mixing ratios produced using the chemical mechanisms is at $40$~\degree C in the High-\chem{NO_x} state when using both a temperature-independent and temperature-dependent source of isoprene emissions.
...
A further test was to compare the box model simulations to the output from a regional 3D model as 3D models include more real-world processes influencing ozone production not included in our box model setup.
...
Directly comparing the ozone mixing ratios from our idealised box model simulations to the WRF-Chem output is difficult due to significant differences in the setup of our box model.
For example, WRF-Chem was setup using gas-phase and aerosol chemistry whereas our box model setup used only gas-phase chemistry also differences in the treatment of photolysis and both VOC and \chem{NO_x} emissions also differ between the our box model and WRF-Chem.
Despite these difficulties in directly comparing the ozone mixing ratios between the box model, WRF-Chem and observations, we compare the rate of change of ozone with temperature (m$_{\text{O3-T}}$).
...
m$_{\text{O3-T}}$ is the linear slope of the increase of ozone with temperature and Table~\ref{t:mo3-t} summarises the calculated slopes of the box model simulations displayed in Fig.~\ref{f:comparison} in ppbv of ozone per \degree C.
...
Out of the metereological conditions not represented by our box model, stagnation is the most likely cause of the missing sensitivity of m$_{\text{O3-T}}$ in the box model compared to the observations and WRF-Chem output.
...
The slower rate of increase of ozone with temperature using our box model setup was obtained compared to the rate of increase of ozone with temperature of observational and 3D model simulations.
...
The lack of mixing meant that secondary VOC oxidation products were allowed to acculate and further degradation producing more ozone than simulations including mixing. 
Accumulation of the secondary oxidation products in stagnant conditions increases the rate of oxidation and in turn the ozone production with temperature, thus the chemical processes driving the increase of ozone with temperature determined in Sect.~\ref{ss:r_budgets} (faster VOC oxidation and peroxy nitrate decomposition) are not altered by stagnant condition but their rates increase.
Thus during heatwaves, stronger reductions in \chem{NO_x} are required to minimise the impact of increase ozone production at higher temperatures on the urban population.
