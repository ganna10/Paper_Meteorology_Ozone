...
\subsection{Temperature Dependent Isoprene Emissions}
\begin{itemize}
    ...
    \item Thus using this idealised case, we can determine the effects of increasing isoprene emissions with temperature across \ce{NO_x} gradients.
...
\begin{figure}%
    ...
    %\includegraphics[width=\textwidth]{img/isoprene_emissions_with_T}
\end{figure}
